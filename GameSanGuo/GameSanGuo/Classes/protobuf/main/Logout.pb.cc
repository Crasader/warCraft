...
void protobuf_AddDesc_Logout_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_Logout_2eproto_once_,
...
LogoutRequest::LogoutRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:main.LogoutRequest)
}
...
LogoutRequest::LogoutRequest(const LogoutRequest& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:main.LogoutRequest)
}
...
LogoutRequest::~LogoutRequest() {
  // @@protoc_insertion_point(destructor:main.LogoutRequest)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:main.LogoutRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:main.LogoutRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:main.LogoutRequest)
  return false;
#undef DO_
}
...
void LogoutRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:main.LogoutRequest)
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:main.LogoutRequest)
}
...
LogoutResponse::LogoutResponse()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:main.LogoutResponse)
}
...
LogoutResponse::LogoutResponse(const LogoutResponse& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:main.LogoutResponse)
}
...
LogoutResponse::~LogoutResponse() {
  // @@protoc_insertion_point(destructor:main.LogoutResponse)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:main.LogoutResponse)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:main.LogoutResponse)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:main.LogoutResponse)
  return false;
#undef DO_
}
...
void LogoutResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:main.LogoutResponse)
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:main.LogoutResponse)
}
