...
local function main()
	...
	--ToDo:在这里绑定资源
	ResourceManager:sharedInstance():bindTexture("sanguobigpic/activityDengLu.plist" , 1 , 191)
	...
	local function createRetLayer(baseTag)
		...
		local orign = CCDirector:sharedDirector():getVisibleOrigin()
	     ...
	     local sumItem  = 7 --总共有几个条目 , 必须大于等于2
        --创建第一个条,最下面的那个
		...
		--该活动的背景图片
		local spriteBg = CCSprite:createWithSpriteFrameName("activityDengLuBg.png")
	...
	runningScene:addChild(createRetLayer(1) , 1  ,654354)
end
